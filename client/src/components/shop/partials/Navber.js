...
import "./style.css";
import "./Navber.css";
import logoNav from '../../../components/assets/logoNav.jpg'
    ...
    <Fragment>
      ...
      <nav className="fixed top-0 w-full z-20 shadow-lg lg:shadow-none bg-white navAll">
        <div className="m-4 md:mx-12 md:my-6 grid grid-cols-4 lg:grid-cols-3">
          ...
          <div className="navMenuButton col-span-2 lg:hidden flex justify-items-stretch	 items-center">
            <svg
          ...
          <div
            onClick={(e) => history.push("/")}
            className="hidden lg:block flex items-left col-span-1 text-center text-gray-800 font-bold tracking-widest uppercase text-1xl cursor-pointer"
          ><img src={logoNav}  alt="NAv Logo" className="navLogoForLargerScreen relative  "/>
          </div>
          <div className="flex items-right col-span-2 lg:col-span-1 flex justify-end">
              ...
              <svg
                className={`${
                  location.pathname === "/wish-list"
                    ? "fill-current text-black hover:text-gray-600"
                    : ""
                } w-8 h-8 text-black cursor-pointer hover:text-gray-600`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
            ...
            {localStorage.getItem("jwt") ? (
              <Fragment>
                ...
                >
                  <svg
                    className="cursor-pointer w-8 h-8 text-black hover:text-gray-600"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              >
                <svg
                  className=" w-8 h-8 text-black hover:text-gray-600"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            >
              ...
              <span className="absolute top-0 ml-6 mt-1 bg-black rounded px-1 text-white text-xs hover:text-gray-200 font-semibold">
